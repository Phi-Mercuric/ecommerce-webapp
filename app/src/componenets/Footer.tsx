    ...
    <section className="flex flex-col items-center sm:py-16 py-6 pl-6 sm:px-32 w-full">
      ...
      <div className='flex flex-row w-full justify-evenly'>
        <div className="flex flex-col sm:mt-3 items-start sm:pl-10">
          <h3 className="text-[15px] sm:text-bg text-gray-400 mb-2 sm:mb-4"> Pages </h3>
        ...
        <div className="flex flex-col sm:mt-3 items-start sm:pl-10">
          <h3 className="text-[15px] sm:text-bg text-gray-400 mb-2 sm:mb-4"> Social Media </h3>
          <div className='grid grid-cols-2 gap-5 sm:gap-x-12 sm:gap-y-5 sm:mx-4'>
